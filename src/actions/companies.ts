...
export async function createCompany(prevState: unknown, formData: FormData) {
  ...
  const permError = requireAdminPermission(session, "COMPANIES");
  ...
  try {
    ...
    console.error(err);
    return fail("Erro interno ao criar empresa.");
  }
}
...
export async function updateCompany(
  ...
  try {
    ...
    console.error(err);
    return fail("Erro interno ao atualizar empresa.");
  }
}
...
export async function deleteCompany(companyId: string) {
  ...
  try {
    ...
    console.error(err);
    return fail("Erro interno ao excluir empresa.");
  }
}
