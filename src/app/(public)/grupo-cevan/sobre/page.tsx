...
export default function SobrePage() {
  return (
    <div className="flex flex-col w-full font-sans bg-white text-[#0B1222] overflow-hidden">
      ...
      {/* ── HERO ── */}
      <section className="relative min-h-[80vh] sm:min-h-[85vh] flex items-center overflow-hidden pt-24 sm:pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-12 w-full py-12 sm:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8">
              <motion.div initial={fu} animate={ft(0)} className="flex items-center gap-2 mb-7 sm:mb-10">
              ...
              <motion.h1 initial={fu} animate={ft(0.1)}
                className="text-[2.6rem] sm:text-6xl lg:text-[5.5rem] font-black leading-[0.95] tracking-[-0.04em] mb-7 sm:mb-10">
              ...
              <motion.p initial={fu} animate={ft(0.2)}
                className="text-slate-500 text-base sm:text-xl font-medium leading-relaxed max-w-2xl mb-10 sm:mb-12">
              ...
              <motion.div initial={fu} animate={ft(0.3)} className="grid grid-cols-3 gap-4 sm:flex sm:flex-wrap sm:gap-12">
                {[
                  ...
                  <div key={s.l}>
                    <p className="text-3xl sm:text-4xl font-black tracking-tighter text-[#0B1222]">{s.n}</p>
      ...
      {/* ── ESSÊNCIA ── */}
      <section className="py-14 sm:py-24 lg:py-36 bg-[#0B1222] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            <motion.div initial={fu} whileInView={ft(0)} viewport={VIEW} className="lg:col-span-4 lg:sticky lg:top-32">
              <p className="text-[11px] font-bold uppercase tracking-widest text-blue-400 mb-5">Nossa Essência</p>
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {[
                ...
                <motion.div key={item.title} initial={fu} whileInView={ft(i * 0.1)} viewport={VIEW}
                  className="bg-white/5 border border-white/10 rounded-2xl sm:rounded-[2rem] p-7 sm:p-10 hover:bg-white/10 hover:border-white/20 active:scale-[0.98] transition-all duration-300">
                  <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-2xl bg-[#1967D2]/20 flex items-center justify-center mb-6 sm:mb-8">
                    <item.icon className="h-6 w-6 sm:h-7 sm:w-7 text-blue-400" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black mb-3">{item.title}</h3>
                  <p className="text-slate-400 font-medium leading-relaxed text-sm sm:text-base">{item.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <section className="py-14 sm:py-24 lg:py-36 bg-white">
        <div className="max-w-7xl mx-auto px-5 lg:px-12">
          <motion.div initial={fu} whileInView={ft(0)} viewport={VIEW} className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0B1222] tracking-tighter">Nossos Valores</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 sm:gap-10">
            {values.map((v, i) => (
              <motion.div key={v.title} initial={fu} whileInView={ft(i * 0.05)} viewport={VIEW}
                ...
                <div className="h-11 w-11 sm:h-12 sm:w-12 rounded-2xl bg-slate-50 flex items-center justify-center shrink-0 group-hover:bg-blue-50 transition-colors">
                  <v.icon className="h-5 w-5 text-slate-400 group-hover:text-[#1967D2] transition-colors" />
                </div>
                <div>
                  <h4 className="text-base sm:text-lg font-black text-[#0B1222] mb-2">{v.title}</h4>
      ...
      {/* ── JORNADA ── */}
      <section className="py-14 sm:py-24 lg:py-36 bg-[#f8faff] overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            <motion.div initial={fu} whileInView={ft(0)} viewport={VIEW} className="lg:col-span-4">
              <p className="text-[11px] font-bold uppercase tracking-widest text-[#1967D2] mb-5">Nossa Jornada</p>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0B1222] tracking-tighter leading-tight">
              ...
              <div className="space-y-8 sm:space-y-12">
                {timeline.map((item, i) => (
                  <motion.div key={item.year} initial={fu} whileInView={ft(i * 0.05)} viewport={VIEW}
                    className={`relative flex flex-col ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"} items-start lg:items-center gap-6 lg:gap-0`}>

                    <div className="flex-1 w-full pl-10 lg:pl-0 lg:px-12 text-left lg:text-right group">
                      <div className={`p-5 sm:p-6 rounded-2xl border border-slate-100 bg-white hover:border-[#1967D2]/20 hover:shadow-lg transition-all duration-300 ${i % 2 !== 0 ? "lg:text-left" : ""}`}>
                        <span className="text-lg sm:text-xl font-black text-[#1967D2] mb-2 block">{item.year}</span>
                        <h3 className="text-base sm:text-lg font-black text-[#0B1222] mb-2">{item.title}</h3>
      ...
      <section className="py-14 sm:py-24 lg:py-36 bg-white">
        <div className="max-w-7xl mx-auto px-5 lg:px-12">
          <motion.div initial={fu} whileInView={ft(0)} viewport={VIEW} className="text-center mb-12 sm:mb-20">
            <p className="text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-5">Time Executivo</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0B1222] tracking-tighter">Liderança do Grupo</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
            {leadership.map((person, i) => (
              <motion.div key={person.name} initial={fu} whileInView={ft(i * 0.1)} viewport={VIEW}
                ...
                <div className="h-28 sm:h-40 lg:h-48 w-full rounded-2xl sm:rounded-[2.5rem] bg-slate-50 flex items-center justify-center text-xl sm:text-3xl font-black text-slate-200 mb-4 sm:mb-6 group-hover:bg-blue-50 group-hover:text-[#1967D2] transition-all duration-500 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  {person.initials}
                </div>
                <h4 className="font-black text-[#0B1222] text-sm sm:text-lg mb-1 text-center">{person.name}</h4>
                <p className="text-[10px] sm:text-xs font-bold text-[#1967D2] uppercase tracking-widest text-center">{person.role}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA FINAL ── */}
      <section className="py-16 sm:py-24 lg:py-36 bg-[#0B1222] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 text-center">
          <motion.div initial={fu} whileInView={ft(0)} viewport={VIEW}>
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white tracking-tighter leading-[0.95] mb-8 sm:mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/#contato"
                className="group inline-flex items-center justify-center gap-3 h-14 sm:h-16 px-10 sm:px-12 rounded-2xl bg-[#1967D2] hover:bg-blue-600 active:scale-[0.98] text-white font-black uppercase tracking-widest text-[12px] transition-all hover:-translate-y-1 shadow-2xl shadow-blue-900/50">
                Falar com a Gente <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/grupo-cevan"
                className="inline-flex items-center justify-center gap-2 h-14 sm:h-16 px-10 sm:px-12 rounded-2xl border-2 border-white/10 text-white/60 hover:text-white hover:border-white/30 active:scale-[0.98] font-bold uppercase tracking-widest text-[12px] transition-all">
                Explorar Empresas
              </Link>
            </div>
          </motion.div>
