...
const ACTION_LABELS: Record<string, { label: string; color: string }> = {
  ...
  ENTRY_FEE_PAID:     { label: "Taxa de entrada paga",  color: "bg-cyan-100 text-cyan-800" },
  ENTRY_FEE_WAIVED:   { label: "Taxa dispensada",       color: "bg-slate-100 text-slate-600" },
  DELETE_JOB:         { label: "Vaga excluída",         color: "bg-rose-100 text-rose-800" },
