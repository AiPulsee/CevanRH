...
export default function CandidatesKanban() {
  const getStageTooltip = (id: string) => {
    switch (id) {
      case "new": return "Candidatos que acabaram de se inscrever e aguardam triagem inicial.";
      case "screening": return "Processo de análise detalhada de currículo e compatibilidade.";
      case "interview": return "Talentos qualificados em fase de entrevistas técnicas ou culturais.";
      case "offer": return "Etapa final de negociação e envio de proposta oficial.";
      case "hired": return "Contratação finalizada com sucesso.";
      default: return "";
    }
  };
