...
export function CreateCompanyModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger 
        render={
          <Button className="rounded-xl font-bold h-12 px-6 bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200">
      ...
      <DialogContent className="sm:max-w-xl w-[95vw] bg-white rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <select id="plan" className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50 text-sm font-bold focus:ring-2 focus:ring-indigo-500/20 outline-none">
                <option>FREE</option>
        ...
        <DialogFooter className="p-8 bg-slate-50 border-t border-slate-100 gap-3">
          ...
          <Button className="rounded-xl font-black h-12 px-10 bg-indigo-600 hover:bg-indigo-700 text-white shadow-xl shadow-indigo-200 uppercase text-xs tracking-widest">
            Criar Registro
          </Button>
        </DialogFooter>
      </DialogContent>
